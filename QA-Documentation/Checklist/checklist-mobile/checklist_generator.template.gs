 ...
 * Template: claude_code_template_instructions_v5.md, MOBILE variant.
 ...
 * ['iOS','Android'] -> 2 columns, 28 cols A..AB). Add platforms, e.g.
 * ['iOS','Android','Windows','HarmonyOS'], and the whole layout, counters, result
 * formula (Partial-aware) and conditional formats recompute (NCOLS = 3*P + 22).
 * The web variant is the same engine with a 1-platform default ('Web').
 *
